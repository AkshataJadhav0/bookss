...
let busiprodsdiv=document.querySelector(".busi")
let techprodsdiv=document.querySelector(".tech")
let romprodsdiv=document.querySelector(".rom")
let advprodsdiv=document.querySelector(".adv")
let ficprodsdiv=document.querySelector(".fic")
...
let books=[
    ...
    
    {
        ...
        namee:"Tips of simple lifestyle" ,
        author:"Bratt Smith",
        price:40,
        stock:10,
        qty:0
...

    {
        ...
        namee:"Simple way of piece life" ,
        author:"Armor Ramsey",
        price:40,
        stock:20,
        qlt:0
...
cartitemsel.innerHTML+=`
                  ...
                  <tbody>
                    ...
                    <td><p style="font-size:13px;">${item.namee}</p></td>
                    <td>$${item.price}</td>
